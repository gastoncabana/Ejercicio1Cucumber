...
public class ContactPage extends DriverFactory {
	...
	private static String AddressInfoLbl[] = { "Mailing City", "Mailing State/Province", "Mailing Zip/Postal Code",
			"Mailing Country", "Other City", "Other State/Province", "Other Zip/Postal Code", "Other Country" };

	// Contact address lbl data
	private static String AddressInfoLblData[] = { "Maldonado", "Maldonado", "20000", "Uruguay", "Maldonado",
	...
	private static String SelectAdditionalOption[] = {
